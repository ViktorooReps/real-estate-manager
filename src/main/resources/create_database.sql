...
INSERT INTO Clients (client_id, client_name, email, phone_number)
    VALUES (1,  'Mark Markovich',   'mark@m.com',   '+77777777'),
           (2,  'Bob Bobich',       'bob@m.com',    '+77778888'),
           (3,  'John Johnovich',   'john@m.com',   '+77734737'),
           (4,  'Steve Stevenson',  'steve@m.com',  '+73942432'),
...
INSERT INTO Offers (offer_id, offered_by, contract_type, estate_type, estate_facade, space, commodities, floor,
    ...
    VALUES (1, 1, 'long-term rental', 'cottage', 'wood', '{"total": 200, "kitchen": 29, "bedroom": 40}',
            '{"Internet": true, "sauna": true, "furniture": true}', 1, 'new', '{"train": 30}', 'Moscow region', 70000,
            'Spinoza st. 187/2'),
           (2, 1, 'short-term rental', 'cottage', 'wood', '{"total": 200, "kitchen": 29, "bedroom": 40}',
            '{"Internet": true, "sauna": true, "furniture": true}', 1, 'new', '{"train": 30}', 'Moscow region', 5000,
            'Spinoza st. 187/2'),
           (3, 1, 'purchase', 'cottage', 'wood', '{"total": 200, "kitchen": 29, "bedroom": 40}',
            '{"Internet": true, "sauna": true, "furniture": true}', 1, 'new', '{"train": 30}', 'Moscow region', 9000000,
            'Spinoza st. 187/2'),
           (4, 4, 'purchase', 'room', 'brick', '{"total": 30, "bedroom": 30}', '{"Internet": true, "furniture": false}',
            1, '90s', '{"metro": 10, "bus": 5}', 'Moscow outside MKAD', 500000, 'Leibniz st. 34/1'),
           (5, 4, 'purchase', 'room', 'brick', '{"total": 50, "bedroom": 50}', '{"Internet": true, "furniture": false}',
