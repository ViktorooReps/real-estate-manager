...
import ru.msu.cmc.realestatemanager.model.dao.impl.ClientActionsImpl;
...
public class DAOFactory {
    ...
    private static ClientActionsImpl clientActions = null;
    ...
    public ClientActions getClientActions() {
        if (clientActions == null) {
            clientActions = new ClientActionsImpl();
        }
